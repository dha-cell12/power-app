  ...
  .init({
    resources: {
      en: {
        translation: {
          refresh: 'Refresh',
          account_already_have: 'Already have an account?',
          ...
          settings_chrome_launch_args: 'Chrome Launch Args',
          settings_chrome_launch_args_tip: 'One parameter per line, e.g. --restore-last-session',
          ...
          extension_delete_confirm_title: 'Delete Confirmation',
          extension_delete_confirm_content:
            'Are you sure you want to delete this extension? This operation cannot be undone.',
          ...
          sync_cascade_button: 'Cascade',
          sync_cascade_settings: 'Cascade Settings',
          sync_cascade_width: 'Width',
          sync_cascade_height: 'Height',
          sync_cascade_spacing: 'Spacing',
      ...
      zh: {
        translation: {
          ...
          settings_chrome_launch_args: 'Chrome 启动参数',
          settings_chrome_launch_args_tip: '每行一个参数，例如 --restore-last-session',
          ...
          sync_cascade_button: '层叠排列',
          sync_cascade_settings: '层叠设置',
          sync_cascade_width: '宽度',
          sync_cascade_height: '高度',
          sync_cascade_spacing: '间隔',
