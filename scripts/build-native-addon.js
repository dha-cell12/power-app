...
/**
 * Build native modules based on platform and architecture and organize output files
 * This script will:
 * 1. Determine the current operating system and architecture
 * 2. Execute appropriate build commands
...
console.log(`Building native module (Platform: ${platform}, Architecture: ${arch})`);
...
// Create platform and architecture specific target directory path
...
try {
  ...
  // Execute different build commands based on platform and architecture
  console.log(`Starting build of native module for ${platform}-${arch}...`);
